...
public class AccessModEncapsulation {

    public static void main(String[] args) {

        PersonForAccess kate = new PersonForAccess("Kate", 32, "Baker Street", "+12334567");
...
class PersonForAccess {
    ...
    public PersonForAccess(String name, int age, String address, String phone){
        this.name = name;
        this.age = age;
